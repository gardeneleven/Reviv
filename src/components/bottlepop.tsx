...
{phase === 'flavors' && (
  ...
  >
    <div className="relative w-full h-full flex items-center justify-center">
      ...
      {/* Bottle layer – below title */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-[40] w-[70vw] max-w-[600px] aspect-[3/4]">
        <div className="relative w-full h-full">
          <Image
      ...
      {/* Buttons – above title if needed, or set to z-[70] */}
      <div className="absolute right-8 top-1/2 -translate-y-1/2 flex items-center gap-6 z-[70]">
